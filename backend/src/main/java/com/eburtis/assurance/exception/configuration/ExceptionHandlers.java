package com.eburtis.assurance.exception.configuration;

import com.eburtis.assurance.exception.AssuranceException;
import com.eburtis.assurance.presentation.dto.erreur.ErreurApi;
...
public class ExceptionHandlers extends ResponseEntityExceptionHandler {
	...
	public void handleAssuranceException(AssuranceException ex, HttpServletResponse response) {
		response.setStatus(ex.getStatus().value());
		ErreurApi erreur = new ErreurApi(ex.getCode(), ex.getMessage(), ex.getDetails());
	...
	public void handleIllegalArgumentException(IllegalArgumentException ex, HttpServletResponse response) {
		...
		ErreurApi erreur = new ErreurApi("REQUETE_INVALIDE", ex.getMessage(), java.util.List.of());
		log.warn("{} - {}", erreur.getCode(), erreur.getMessage());
		setReponseJson(erreur, response);
	}
